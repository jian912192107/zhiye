...
$(document).bind('lastexec',function(){
    ...
    function resizeCanvasHeight(){
        ...
        $('#scroll_container_bg').css('height',(canvheight+$('#site_footer').height()+footermargintop)+'px');
...
function wp_pages_global_func(params){
    ...
    window['parseToURL'] = function(module,action,anotherparams){
        ...
        return params.punyurl+"/index.php?"+paramstr;
    };
                        ...
                        if(!$.wismobile&&self.closest('#canvas').length ){
                            _getEffectDom(self).done(function(){
                                ...
                                if(cancontainer.length){
                                    ...
                                    if(effects.effect!='rotation2d' && effects.effect!='light') stacks.push(self);
                    ...
                    if(imgeffects.type=="tb_product_list" || imgeffects.type=="product_list" || imgeffects.type=="seckill_list" || imgeffects.type=="groupon_list" || imgeffects.type=="jfpro_list"){
                        self.each(function(){
                            ...
                            if(!$(this).siblings('#imgmask').length) {
                                $(this).after('<div id="imgmask" class="imgmask" data-color="'+colorval+'" data-opacity="'+opacity+'" style=" position: absolute; top: 0px;left:0px; background:'+bgcolor+';z-index: 1002; left: 0px;width:'+width+'px;height:'+height+'px;">' +
